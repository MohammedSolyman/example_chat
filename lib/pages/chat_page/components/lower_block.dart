...
class LowerBlock extends StatelessWidget {
  const LowerBlock({required this.roomId, required this.recieverId, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    AuthController authControler = Get.find<AuthController>();
                    ...
                    onPressed: () async {
                      ...
                      if (file != null) {
                        ...
                        MessageModel message = messageController.prepareMessage(
                            ...
                            currentUser: authControler.model.value.currentUser!,
                            body: downloadLink!,
